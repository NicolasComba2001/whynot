...
export default function Benefits(){
    return(
        <section className='flex flex-col gap-4 mt-12 items-center md:flex-row'>
            <article className='w-[250px] p-4 flex flex-col justify-center  border-l-2 border-orange-200 md:w-[230px]'>
