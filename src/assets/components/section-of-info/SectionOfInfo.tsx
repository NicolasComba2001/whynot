        ...
        <>
            <section className="m-auto flex flex-col justify-center items-center w-full bg-[#1a1a1a] mt-20">
                <figure className="flex justify-center w-[350px] h-[350px] p-8 rounded relative">
                    <img src="https://images.pexels.com/photos/1563355/pexels-photo-1563355.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="" className="w-full h-full rounded p-2 border hidden 
                    md:block md:translate-x-[-210px] md:rotate-[-14deg] absolute bottom-0 md:w-2/4 md:h-2/4"/>
                    ...
                    <img src="https://images.pexels.com/photos/60597/dahlia-red-blossom-bloom-60597.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" className="w-full h-full rounded p-2 border hidden 
                    md:block md:translate-x-[210px] md:rotate-[14deg] absolute bottom-0 md:w-2/4 md:h-2/4"/>
                </figure>
                <article className="flex flex-col p-4 w-full justify-center items-center">
